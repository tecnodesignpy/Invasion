...
def resultados(request):
    result = logrado.objects.filter(mes=10).aggregate(discipulos=Sum('discipulos'),ganar=Sum('ganar'),consolidar_agua=Sum('consolidar_agua'), consolidar_espiritu=Sum('consolidar_espiritu'),consolidar_seminario=Sum('consolidar_seminario'),discipular_caminando=Sum('discipular_caminando'),discipular_escuela=Sum('discipular_escuela'),discipular_imparticion=Sum('discipular_imparticion'),discipular_vocacional=Sum('discipular_vocacional'), multiplicar=Sum('multiplicar'),)
    print(result)
